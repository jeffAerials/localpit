...
use LocalAssault\AppInitBundle\Entity\Essai;
...
class EssaiController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $essais = $em->getRepository('LocalAssaultAppInitBundle:Essai')->findAll();

        return $this->render('LocalAssaultAppInitBundle:essai:index.html.twig', array(
            'essais' => $essais,
        ));
    }
    ...
    {
        $essai = new Essai();
        $form = $this->createForm('LocalAssault\AppInitBundle\Form\EssaiType', $essai);
        ...
        return $this->render('LocalAssaultAppInitBundle:essai:new.html.twig', array(
            'essai' => $essai,
    ...
    public function showAction(Essai $essai)
    {
        ...
        return $this->render('LocalAssaultAppInitBundle:essai:show.html.twig', array(
            'essai' => $essai,
    ...
    {
        $deleteForm = $this->createDeleteForm($essai);
        $editForm = $this->createForm('LocalAssault\AppInitBundle\Form\EssaiType', $essai);
        ...
        return $this->render('LocalAssaultAppInitBundle:essai:edit.html.twig', array(
            'essai' => $essai,
